...
There are 11 MPs not identified, let´s fix our data with information from the [internet](https://membersafter1832.historyofparliamentonline.org/members):
...
I chose the regular Roberta by trying to input different speeches and realising that for regular topics the newest [RoBERTa](https://huggingface.co/cardiffnlp/twitter-roberta-base-sentiment-latest) model classified better such speeches than the [RoBERTa trained on political tweets](https://huggingface.co/cardiffnlp/xlm-twitter-politics-sentiment?text=A+mistaken+impression+has+been+created+in+this+debate+that+all+that+food+banks+do+is+distribute+emergency+food.+What+they+actually+do+is+give+financial+advice+and+debt+advice+to+people+who+have+got+into+difficult+situations%E2%80%94emergency+food+is+only+part+of+what+they+do):
...
Add [Brexit results](https://commonslibrary.parliament.uk/brexit-votes-by-constituency/) to my df:
...
[SNP](https://www.facebook.com/theSNP/?locale=es_ES)

[labour](https://onlineresize.club/2021-club.html)

[conservative](https://respublicagame.fandom.com/wiki/Conservative_Party_(UK))

[labourco-operative](https://www.castlepointlabour.org.uk/labour-co-operative/)

[liberal-democrat](https://www.politics.co.uk/news/2011/09/19/lib-dems-have-best-party-logo/)

[dup](https://en.wikipedia.org/wiki/Democratic_Unionist_Party)
...
(I need to assign names to the topics created)
...
[https://huggingface.co/unhcr/hatespeech-detection](https://huggingface.co/unhcr/hatespeech-detection?text=idiot){.uri}
